...
class UniqueProductState extends CommonObject
{
	 ...
	 */
	public $module = 'uniqueproductstate';
	...
	public function getNextNumRef()
	{
		...
		if (!empty($conf->global->UNIQUEPRODUCTSTATE_UNIQUEPRODUCTSTATE_ADDON))
		{
			...
			{
				$dir = dol_buildpath($reldir."core/modules/uniqueproductstate/");
...
/**
 * Class UniqueProductStateLine. You can also remove this and generate a CRUD class for lines objects.
 */
class UniqueProductStateLine extends CommonObjectLine
{
	// To complete with content of an object UniqueProductStateLine
	// We should have a field rowid, fk_uniqueproductstate and position
