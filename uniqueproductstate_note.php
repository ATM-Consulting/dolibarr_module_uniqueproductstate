...
/**
 *  \file       uniqueproductstate_note.php
 *  \ingroup    uniqueproductstate
 *  \brief      Tab for notes on UniqueProductState
 */
...
$langs->loadLangs(array("uniqueproductstate@uniqueproductstate", "companies"));
...
$hookmanager->initHooks(array('uniqueproductstatenote', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($id > 0 || !empty($ref)) $upload_dir = $conf->uniqueproductstate->multidir_output[$object->entity]."/".$object->id;
...
$help_url = '';
llxHeader('', $langs->trans('UniqueProductState'), $help_url);
...
if ($id > 0 || !empty($ref))
{
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("UniqueProductState"), -1, $object->picto);
