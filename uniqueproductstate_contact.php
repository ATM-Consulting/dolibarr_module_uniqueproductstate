...
/**
 *  \file       uniqueproductstate_contact.php
 *  \ingroup    uniqueproductstate
 *  \brief      Tab for contacts linked to UniqueProductState
 */
...
$hookmanager->initHooks(array('uniqueproductstatecontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('UniqueProductState')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id)
{
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("UniqueProductState"), -1, $object->picto);
